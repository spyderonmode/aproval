...
export const translations = {
  ...
  winFiveConsecutiveGames: {
    ...
    ar: 'اربح 5 ألعاب متتالية دون خسارة - أظهر ثباتك!',
    bn: 'হার না মেনে পরপর 5টি গেম জিতুন - আপনার ধারাবাহিকতা দেখান!',
    hi: 'बिना हारे 5 लगातार गेम जीतें - अपनी निरंتरता दिखाएं!',
  ...
  winTenConsecutiveGames: {
    ...
    ar: 'اربح 10 ألعاب متتالية دون خسارة لفتح موضوع الهالوين!',
    bn: 'হ্যালোইন থিম আনলক করতে হার না মেনে পরপর 10টি গেম জিতুন!',
    hi: 'हैलोवीन थीम अनलॉक करने के लिए बिना हारे 10 लगातार गेम जीतें!',
