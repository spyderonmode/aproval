...
export const translations = {
  ...
  quickMatchedWithOpponent: {
    ...
    hi: 'आपका मैच एक प्रतिद्वंद्वी के साথ हो गया है। गेम शुরू हो রहা है...',
  ...
  blocked: {
    en: 'This user has blocked you and you cannot send messages to them.',
    ar: 'هذا المستخدم قام بحجبك ولا يمكنك إرسال رسائل إليه.',
    bn: 'এই ব্যবহারকারী আপনাকে ব্লক করেছে এবং আপনি তাদের কাছে বার্তা পাঠাতে পারবেন না।',
    hi: 'इस उपयोगकर्ता ने आपको ब्लॉक कर दिया है और आप उन्हें संदेश नहीं भेज सकते।',
    es: 'Este usuario te ha bloqueado y no puedes enviarle mensajes.',
    id: 'Pengguna ini telah memblokir Anda dan Anda tidak dapat mengirim pesan kepada mereka.',
  },
  userOffline: {
    en: 'Your friend is offline. You can send messages when they are online.',
    ar: 'صديقك غير متصل. يمكنك إرسال الرسائل عندما يكون متصلاً.',
    bn: 'আপনার বন্ধু অফলাইনে। তারা অনলাইনে থাকলে আপনি বার্তা পাঠাতে পারেন।',
    hi: 'आपका मित्र ऑफलाइन है। जब वे ऑनलाइन हों तो आप संदेश भेज सकते हैं।',
    es: 'Tu amigo está desconectado. Puedes enviar mensajes cuando estén en línea.',
    id: 'Teman Anda sedang offline. Anda dapat mengirim pesan ketika mereka online.',
  },
  notAuthenticated: {
    en: 'Please log in to continue.',
    ar: 'يرجى تسجيل الدخول للمتابعة.',
    bn: 'চালিয়ে যেতে দয়া করে লগইন করুন।',
    hi: 'जारी रखने के लिए कृपया लॉग इन करें।',
    es: 'Por favor inicia sesión para continuar.',
    id: 'Harap masuk untuk melanjutkan.',
  },
  accessDenied: {
    en: "You don't have permission to perform this action.",
    ar: 'ليس لديك إذن لتنفيذ هذا الإجراء.',
    bn: 'এই কাজটি সম্পাদনের অনুমতি আপনার নেই।',
    hi: 'आपके पास यह क्रिया करने की अनुमति नहीं है।',
  ...
  networkError: {
    ...
    bn: 'দয়া করে আপনার ইন্টারনেট সংযোগ পরীক্ষা করুন এবং আবার চেষ্টা করুন।',
    hi: 'कृपया अपना इंटरनेट कनेक्शन जांचें और पुनः प्रयास করें।',
    es: 'Por favor verifica tu conexión a internet e inténtalo de nuevo.',
    id: 'Harap periksa koneksi internet Anda dan coba lagi.',
  },
  serviceUnavailable: {
    en: 'The service is temporarily unavailable. Please try again later.',
    ar: 'الخدمة غير متاحة مؤقتاً. يرجى المحاولة لاحقاً.',
    bn: 'সেবাটি সাময়িকভাবে অনুপলব্ধ। দয়া করে পরে আবার চেষ্টা করুন।',
    hi: 'सेवा अस्थायी रूप से अनुपलब्ध है। कृपया बाद में पुनः प्रयास करें।',
    es: 'El servicio no está disponible temporalmente. Por favor inténtalo más tarde.',
    id: 'Layanan sementara tidak tersedia. Harap coba lagi nanti.',
  },
  tooManyRequests: {
    en: 'Too many requests. Please wait a moment and try again.',
    ar: 'طلبات كثيرة جداً. يرجى الانتظار قليلاً والمحاولة مرة أخرى.',
    bn: 'অনেক বেশি অনুরোধ। দয়া করে একটু অপেক্ষা করুন এবং আবার চেষ্টা করুন।',
    hi: 'बहुत सारे अनुरोध। कृपया एक क्षण प्रतीक्षा करें और पुनः प्रयास करें।',
    es: 'Demasiadas solicitudes. Por favor espera un momento e inténtalo de nuevo.',
    id: 'Terlalu banyak permintaan. Harap tunggu sebentar dan coba lagi.',
  },
  ...
  failedToResendVerificationEmail: {
    ...
    bn: 'যাচাইকরণ ইমেইল পুনরায় পাঠাতে ব্যর্থ।',
    hi: 'सत्यापन ईमेल पुनः भेजने में विफल।',
    es: 'Error al reenviar el correo de verificación.',
    id: 'Gagal mengirim ulang email verifikasi.',
  },
  failedToResendTryAgain: {
    en: 'Failed to resend verification email. Please try again.',
    ar: 'فشل في إعادة إرسال بريد التحقق. يرجى المحاولة مرة أخرى.',
    bn: 'যাচাইকরণ ইমেইল পুনরায় পাঠাতে ব্যর্থ। দয়া করে আবার চেষ্টা করুন।',
    hi: 'सत्यापन ईमेल पुনः भेजने में विफल। कृपया पुनः प্রयास करें।',
    es: 'Error al reenviar el correo de verificación. Por favor inténtalo de nuevo.',
    id: 'Gagal mengirim ulang email verifikasi. Harap coba lagi.',
  },

  // Password Reset Errors
  resetCodeSent: {
    en: 'Reset Code Sent',
    ar: 'تم إرسال رمز الإعادة تعيين',
    bn: 'রিসেট কোড পাঠানো হয়েছে',
    hi: 'रीसेट कोड भेजा गया',
    es: 'Código de Restablecimiento Enviado',
    id: 'Kode Reset Terkirim',
  },
  failedToSendResetEmail: {
    en: 'Failed to send reset email.',
    ar: 'فشل في إرسال بريد إعادة التعيين.',
    bn: 'রিসেট ইমেইল পাঠাতে ব্যর্থ।',
    hi: 'रीसेट ईमेल भेजने में विफल।',
    es: 'Error al enviar el correo de restablecimiento.',
    id: 'Gagal mengirim email reset.',
  },
  enterResetCode: {
    en: 'Please enter your reset code',
    ar: 'يرجى إدخال رمز الإعادة تعيين الخاص بك',
    bn: 'দয়া করে আপনার রিসেট কোড লিখুন',
    hi: 'कृपया अपना रीसेट कोड दर्ज करें',
    es: 'Por favor ingresa tu código de restablecimiento',
    id: 'Harap masukkan kode reset Anda',
  },
  resetCodeMustBeSixDigits: {
    en: 'Reset code must be 6 digits',
    ar: 'رمز الإعادة تعيين يجب أن يكون 6 أرقام',
    bn: 'রিসেট কোড অবশ্যই 6 সংখ্যার হতে হবে',
    hi: 'रीसेट कोड 6 अंकों का होना चाहिए',
    es: 'El código de restablecimiento debe tener 6 dígitos',
    id: 'Kode reset harus 6 digit',
  },
  passwordsDoNotMatch: {
  ...
  passwordTooShort: {
    ...
    hi: 'पासवर्ড कम से कम 6 अক्षर का होना चাहिए',
  ...
  passwordResetSuccessfully: {
    ...
    bn: 'আপনার পাসওয়ার্ড সফলভাবে রিসেট করা হয়েছে।',
    hi: 'आपका पासवर्ड सफलतापूर्वक रीसेट हो गया है।',
    es: 'Tu contraseña ha sido restablecida exitosamente.',
    id: 'Kata sandi Anda telah berhasil direset.',
  },
  ...
  enterVerificationCode: {
    ...
    ar: 'يرجى إدخال رمز التحقق الخاص بك',
    bn: 'দয়া করে আপনার যাচাইকরণ কোড লিখুন',
    hi: 'कृपया अपना सत्यापन कोड दर्ज करें',
    es: 'Por favor ingresa tu código de verificación',
    id: 'Harap masukkan kode verifikasi Anda',
  },
  verificationCodeMustBeSixDigits: {
    en: 'Verification code must be 6 digits',
    ar: 'رمز التحقق يجب أن يكون 6 أرقام',
    bn: 'যাচাইকরণ কোড অবশ্যই 6 সংখ্যার হতে হবে',
    hi: 'सत्यापन कोड 6 अंकों का होना चाहिए',
    es: 'El código de verificación debe tener 6 dígitos',
    id: 'Kode verifikasi harus 6 digit',
  },
  emailVerified: {
    en: 'Email Verified',
    ar: 'تم التحقق من البريد الإلكتروني',
    bn: 'ইমেইল যাচাই করা হয়েছে',
    hi: 'ईमेल सत्यापित',
  ...
  emailVerifiedSuccessfully: {
    ...
    bn: 'আপনার ইমেইল সফলভাবে যাচাই করা হয়েছে। আপনি এখন লগইন করতে পারেন।',
    hi: 'आपका ईमेल सफलतापूर्वक सत্যापित हो गया है। अब आप लॉग इन कर सकते हैं।',
    es: 'Tu correo ha sido verificado exitosamente. Ahora puedes iniciar sesión.',
    id: 'Email Anda telah berhasil diverifikasi. Sekarang Anda dapat masuk.',
  },
  failedToVerifyEmail: {
    en: 'Failed to verify email',
    ar: 'فشل في التحقق من البريد الإلكتروني',
    bn: 'ইমেইল যাচাই করতে ব্যর্থ',
    hi: 'ईमेल सत्यापित करने में विफल',
    es: 'Error al verificar el correo',
    id: 'Gagal memverifikasi email',
  },
  failedToVerifyEmailTryAgain: {
    en: 'Failed to verify email. Please try again.',
    ar: 'فشل في التحقق من البريد الإলكتروني. يرجى المحاولة مرة أخرى.',
    bn: 'ইমেইল যাচাই করতে ব্যর্থ। দয়া করে আবার চেষ্টা করুন।',
    hi: 'ईमेल सत্यापित করने में विफল। कृपया पुनः प্রयास করें।',
    es: 'Error al verificar el correo. Por favor inténtalo de nuevo.',
    id: 'Gagal memverifikasi email. Harap coba lagi.',
  },
  ...
  gameEndedPlayerLeft: {
    en: 'Game ended because a player left the room.',
    ar: 'انتهت اللعبة لأن أحد اللاعبين ترك الغرفة.',
    bn: 'একজন খেলোয়াড় রুম ছেড়ে দেওয়ায় গেম শেষ হয়েছে।',
    hi: 'खेल समाप्त हो गया क্योंकি एक खिलाड़ी ने कमরा छोड़ दिया।',
    es: 'El juego terminó porque un jugador abandonó la sala.',
    id: 'Permainan berakhir karena seorang pemain meninggalkan ruangan.',
  },
  roomEnded: {
    en: 'Room Ended',
    ar: 'انتهت الغرفة',
  ...
  playerLeftRoomRefreshing: {
    en: 'left the room. Refreshing page...',
    ar: 'ترك الغرفة. يتم تحديث الصفحة...',
    bn: 'রুম ছেড়ে গেছে। পৃষ্ঠা রিফ্রেশ করা হচ্ছে...',
    hi: 'कमरा छोड़ दिया। पेज रिफ्রेश हो रहा है...',
    es: 'abandonó la sala. Actualizando página...',
    id: 'meninggalkan ruangan. Memuat ulang halaman...',
  },
  matchedWithOpponent: {
    en: "You've been matched with an opponent. Game starting...",
    ar: 'تم إقرانك مع خصم. بدء اللعبة...',
    bn: 'আপনাকে একজন প্রতিপক্ষের সাথে ম্যাচ করা হয়েছে। গেম শুরু হচ্ছে...',
    hi: 'आपका मैच एक प्रतिद्वंद्वी के साथ हो गया है। गेम शुरू हो रहा है...',
    es: 'Has sido emparejado con un oponente. Comenzando juego...',
    id: 'Anda telah dipadankan dengan lawan. Permainan dimulai...',
  },
  roomNameRequired: {
    en: 'Room name is required',
    ar: 'اسم الغرفة مطلوب',
    bn: 'রুমের নাম প্রয়োজন',
    hi: 'कमरे का नाम आवश्यक है',
    es: 'Se requiere el nombre de la sala',
    id: 'Nama ruangan diperlukan',
  },
  unauthorized: {
    en: 'Unauthorized',
    ar: 'غير مصرح',
  ...
  loggedOutLoggingIn: {
    en: 'You have been logged out. Logging you in again...',
    ar: 'تم تسجيل خروجك. يتم تسجيل دخولك مرة أخرى...',
    bn: 'আপনাকে লগআউট করা হয়েছে। আবার লগইন করানো হচ্ছে...',
    hi: 'आपको लॉग आउट कर दিया गया है। आपको फिर से लॉग इन कराया जा रहा है...',
    es: 'Has sido desconectado. Iniciando sesión nuevamente...',
    id: 'Anda telah keluar. Memasukkan Anda kembali...',
  }
} as const;
