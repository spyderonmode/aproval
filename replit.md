...
- **Leaderboard Mobile Optimization for Arabic** (July 19, 2025): Optimized leaderboard modal for mobile devices with better space utilization and Arabic language support. Changes include: increased modal viewport usage (98vw on mobile), reduced header padding and spacing on mobile, hidden descriptive text on small screens to save space, optimized card padding and performance badge sizing, and improved footer layout with smaller buttons and text. Added LTR direction override to leaderboard content for proper display of statistics and numbers in Arabic mode while maintaining RTL for overall layout.
