...
- **Achievement Modal Mobile Fix** (July 17, 2025): Fixed achievement tab overlapping with mobile navigation by optimizing modal layout for mobile screens. Changed modal height from 80vh to 85vh, implemented proper flexbox layout with flex-shrink-0 headers and footers, added proper scrolling for content area, and included visual separator for close button. Enhanced tooltip positioning to prevent tooltips from appearing beyond modal boundaries.
