...
- **Legend Achievement with Animated Border** (July 18, 2025): Added new "Legend" achievement for players who reach 50 total wins. Players with this achievement get a spectacular animated border around their name on the game board - cycling through gold, red, and teal glowing effects with pulsing animations. The border includes a golden border with rainbow shadow animation that continuously cycles colors, making Legend players stand out as true champions. Player names also become bold when they have Legend status.
